...
public class buscMarcas extends javax.swing.JDialog {
    ...
    public buscMarcas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.tipo = tipo;
    ...
    private void btnEste1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEste1ActionPerformed
        if (txtId.getText().equals("")) {
            metodos.msgError(null, "Debe ingresar una marca");
            return;
        }

        String aux = instancias.getSql().getDatosMarcas(txtId.getText().toUpperCase());
        if (aux == null) {
            if (metodos.msgPregunta(null, "¿Agregar marca?") == 0) {
                if (!instancias.getSql().agregarMarca(txtId.getText().toUpperCase())) {
                    metodos.msgError(null, "Hubo un error al ingresar la marca");
                    return;
                }
                metodos.msgExito(null, "Marca ingresada con exito");
    ...
    public void setInstancia(Instancias instancia) {
        ...
        tblRegistros.setModel(instancias.getSql().getRegistrosMarcas());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscMarcas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                buscMarcas dialog = new buscMarcas(new javax.swing.JFrame(), true);
