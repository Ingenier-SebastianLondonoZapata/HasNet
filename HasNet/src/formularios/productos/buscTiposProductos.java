...
public class buscTiposProductos extends javax.swing.JDialog {
    ...
    public buscTiposProductos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setTitle("Buscador de tipos de productos...");
        this.tipo = tipo;
    ...
    private void btnEste1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEste1ActionPerformed
        if (txtId.getText().equals("")) {
            metodos.msgError(null, "Ingrese el tipo de producto");
            return;
        }

        String aux = instancias.getSql().getDatosMedidas(txtId.getText());
        if (aux == null) {
            if (metodos.msgPregunta(null, "¿Agregar tipo de producto?") == 0) {

                if (!instancias.getSql().agregarTipoProd(txtId.getText())) {
                    metodos.msgError(null, "Hubo un error al guardar");
                    return;
                }

                metodos.msgExito(null, "Tipo de producto ingresado con exito");
    ...
    public void setInstancia(Instancias instancia) {
        ...
        tblRegistros.setModel(instancias.getSql().getRegistrosTipoProducto());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscTiposProductos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                buscTiposProductos dialog = new buscTiposProductos(new javax.swing.JFrame(), true);
