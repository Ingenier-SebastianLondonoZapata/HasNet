...
public class buscSubGrupos extends javax.swing.JDialog {
    ...
    public buscSubGrupos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        instancias = Instancias.getInstancias();
        String grupo = "";
        if (instancias.getValor() != null) {
            grupo = instancias.getValor();
        }

        String condicion = "";
        if (!grupo.equals("")) {
            condicion = " where grupo = '" + grupo + "' ";
        }

        tblRegistros.setModel(instancias.getSql().getRegistrosSubGrupos(condicion));
    ...
    private void initComponents() {
        ...
        setTitle("Buscador de subgrupos...");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscGrupos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
