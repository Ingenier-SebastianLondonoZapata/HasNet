...
public class buscUsuarios extends javax.swing.JDialog {

    DefaultTableModel modelo;
    TableRowSorter modeloOrdenado;
    Instancias instancias;
   
    public buscUsuarios(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        instancias = Instancias.getInstancias();
        tblRegistros.setModel(instancias.getSql().getRegistrosUsuarios());
    ...
    private void initComponents() {
        ...
        rd1.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        rd1.setText("Nombre");

        rd2.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscUsuarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                buscUsuarios dialog = new buscUsuarios(new javax.swing.JFrame(), true);
