...
public class infCocaina extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        lbNit10.setText("DETERMINACIÓN DE COCAINA");
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/anterior_1.png"))); // NOI18N
        jLabel13.setText("VOLVER A LA CONSULTA");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (metodos.msgPregunta(this, "¿Desea continuar?") == 0) {
            ...
            String id = "COCAINA-" + instancias.getSql().getNumConsecutivo("COCAINA")[0];

            if (!instancias.getSql().agregarCocaina(id, txtIdentificacion.getText(), txtNumeroOrden.getText(), "", metodosGenerales.fecha(),
            ...
            if (!instancias.getSql().aumentarConsecutivo("COCAINA", Integer.parseInt((String) instancias.getSql().getNumConsecutivo("COCAINA")[0]) + 1)) {
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        if (!txtIdentificacion.getText().equals("")) {
            ...
            impresion.cargarRegistros(txtIdentificacion.getText(), "cocaina", instancias);
