...
public class infDirecto extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        txtLeucocitaria = new javax.swing.JTextField();
        lbRazon10 = new javax.swing.JLabel();
        txtBacterias = new javax.swing.JTextField();
        jPanel2 = new javax.swing.JPanel();
        rbtFlujo = new javax.swing.JRadioButton();
        rbtSecrecion = new javax.swing.JRadioButton();
        ...
        lbNit10.setText("DIRECTO Y GRAM");
        ...
        lbNit29.setBackground(new java.awt.Color(204, 204, 204));
        lbNit29.setFont(new java.awt.Font("Century Gothic", 1, 20)); // NOI18N
        lbNit29.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbNit29.setText("GRAM");
        lbNit29.setOpaque(true);

        txtResultado1.setColumns(20);
        txtResultado1.setLineWrap(true);
        txtResultado1.setRows(2);
        jScrollPane4.setViewportView(txtResultado1);

        lbRazon8.setFont(new java.awt.Font("Century Gothic", 1, 16)); // NOI18N
        lbRazon8.setText("Reacción leucocitaria:");

        txtLeucocitaria.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        txtLeucocitaria.setName("Fecha De Nacimiento"); // NOI18N
        txtLeucocitaria.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtLeucocitariaKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtLeucocitariaKeyTyped(evt);
            }
        });

        lbRazon10.setFont(new java.awt.Font("Century Gothic", 1, 16)); // NOI18N
        lbRazon10.setText("Bacterias:");

        txtBacterias.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        txtBacterias.setName("Fecha De Nacimiento"); // NOI18N
        txtBacterias.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtBacteriasKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(lbRazon10, javax.swing.GroupLayout.DEFAULT_SIZE, 181, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtBacterias)
                            .addComponent(txtLeucocitaria))))
                .addContainerGap())
        );
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(lbNit29, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lbRazon8, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtLeucocitaria, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lbRazon10, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtBacterias, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        buttonGroup1.add(rbtFlujo);
        rbtFlujo.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        rbtFlujo.setSelected(true);
        rbtFlujo.setText("FLUJO VAGINAL");
        rbtFlujo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rbtFlujoActionPerformed(evt);
            }
        });

        buttonGroup1.add(rbtSecrecion);
        rbtSecrecion.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        rbtSecrecion.setText("SECRECIÓN URETAL");
        rbtSecrecion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rbtSecrecionActionPerformed(evt);
            }
        });

        buttonGroup1.add(rbtOtro);
        rbtOtro.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        ...
        txtOtro.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        txtOtro.setName("Fecha De Nacimiento"); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(rbtFlujo)
                .addGap(36, 36, 36)
                .addComponent(rbtSecrecion)
                .addGap(45, 45, 45)
                .addComponent(rbtOtro)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(txtOtro, javax.swing.GroupLayout.PREFERRED_SIZE, 434, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(rbtOtro, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(txtOtro, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    public void cargarCliente(String nit) {
        ...
        ModeloContacto Tercero = sql.getDatosTercero(nit);
...
//            txtRemitido.setText(metodos.fecha(Tercero.getNacimiento()));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        Object[] campos = {txtIdentificacion, txtResultado};
        ...
        if (metodos.msgPregunta(this, "¿Desea continuar?") == 0) {
            ...
            String id = "DIRECTO-" + instancias.getSql().getNumConsecutivo("DIRECTO")[0];

            String opcion = "";
            if (rbtFlujo.isSelected()) {
                opcion = "FLUJO VAGINAL";
            } else if (rbtSecrecion.isSelected()) {
                opcion = "SECRECIÓN URETRAL";
            } else if (rbtOtro.isSelected()) {
                opcion = txtOtro.getText();
                opcion = opcion.toUpperCase();
            }

            if (!instancias.getSql().agregarDirecto(id, txtIdentificacion.getText(), txtNumeroOrden.getText(), txtRemitido.getText(), metodosGenerales.fecha(),
                    opcion, txtTecnica.getText(), txtObservaciones.getText(), txtResultado.getText(), txtResultado1.getText(), txtLeucocitaria.getText(),
                    txtBacterias.getText())) {
                metodos.msgError(this, "Hubo un problema al guardar");
                return;
            }

            if (!instancias.getSql().aumentarConsecutivo("DIRECTO", Integer.parseInt((String) instancias.getSql().getNumConsecutivo("DIRECTO")[0]) + 1)) {
            ...
            if (metodos.msgPregunta(this, "¿Desea imprimir?") == 0) {
                ...
                instancias.getReporte().ver_Examen(id, instancias.getInformacionEmpresa(), legal, pie, txtEdad.getText(), "directos");
            }
            btnLimpiarActionPerformed(evt);
        }
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        if (!txtIdentificacion.getText().equals("")) {
            ...
            impresion.cargarRegistros(txtIdentificacion.getText(), "directo", instancias);
    ...
    private void btnLimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLimpiarActionPerformed
        ...
        txtBacterias.setText("");
        txtLeucocitaria.setText("");
    ...
    private void rbtFlujoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbtFlujoActionPerformed
        if (rbtFlujo.isSelected() || rbtSecrecion.isSelected()) {
            txtOtro.setText("");
            txtOtro.setEnabled(false);
        }
    }//GEN-LAST:event_rbtFlujoActionPerformed

    private void rbtSecrecionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbtSecrecionActionPerformed
        if (rbtFlujo.isSelected() || rbtSecrecion.isSelected()) {
            txtOtro.setText("");
            txtOtro.setEnabled(false);
        }
    }//GEN-LAST:event_rbtSecrecionActionPerformed
    ...
    private void txtLeucocitariaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtLeucocitariaKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_txtLeucocitariaKeyReleased

    private void txtLeucocitariaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtLeucocitariaKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_txtLeucocitariaKeyTyped

    private void txtBacteriasKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBacteriasKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_txtBacteriasKeyReleased
    ...
    public void reimprimir(String consecutivo) {
        ...
        instancias.getReporte().ver_Examen(consecutivo, instancias.getInformacionEmpresa(), legal, pie, txtEdad.getText(), "directos");
    }
