...
public class infEmbarazo extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        lbNit11.setText("PRUEBA INMUNOLOGICA DE EMBARAZO");

        jPanel5.setBackground(new java.awt.Color(255, 255, 255));
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(""));

        txtLote.setFont(new java.awt.Font("Century Gothic", 0, 24)); // NOI18N
        txtLote.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtLote.setName("No. Identificacion"); // NOI18N
        ...
        txtFecha.setName("No. Identificacion"); // NOI18N
        ...
        lbNit26.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbNit26.setText("Lote:");

        lbNit46.setFont(new java.awt.Font("Century Gothic", 0, 16)); // NOI18N
        lbNit46.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbNit46.setText("Fecha Exp:");

        lbNit53.setFont(new java.awt.Font("Century Gothic", 0, 16)); // NOI18N
        lbNit53.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbNit53.setText("Marca:");

        txtMarca.setFont(new java.awt.Font("Century Gothic", 0, 24)); // NOI18N
        txtMarca.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtMarca.setName("No. Identificacion"); // NOI18N
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(lbNit26, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(lbNit46, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(lbNit53, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lbNit26, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//            txtRemitido.setText(metodos.fecha(Tercero.getNacimiento()));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (metodos.msgPregunta(this, "¿Desea continuar?") == 0) {
            ...
            String id = "EMBARAZO-" + instancias.getSql().getNumConsecutivo("EMBARAZO")[0];

            if (!instancias.getSql().agregarEmbarazo(id, txtIdentificacion.getText(), txtNumeroOrden.getText(), txtRemitido.getText(), metodosGenerales.fecha(),
                    cmbResultado.getSelectedItem().toString(), txtTecnica.getText(), txtObservaciones.getText(), txtLote.getText(), txtFecha.getText(), txtMarca.getText())) {
                metodos.msgError(this, "Hubo un problema al guardar");
                return;
            }

            if (!instancias.getSql().aumentarConsecutivo("EMBARAZO", Integer.parseInt((String) instancias.getSql().getNumConsecutivo("EMBARAZO")[0]) + 1)) {
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        if (!txtIdentificacion.getText().equals("")) {
            ...
            impresion.cargarRegistros(txtIdentificacion.getText(), "embarazo", instancias);
