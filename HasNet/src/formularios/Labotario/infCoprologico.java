...
public class infCoprologico extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tblTabla3.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "HELMINTOS", "HUEVOS /gr", "GRADO DE INFESTACIÓN"
            }
        ));
...
//            txtRemitido.setText(metodos.fecha(Tercero.getNacimiento()));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (metodos.msgPregunta(this, "¿Desea continuar?") == 0) {
            ...
            String id = "COPROLOGICO-" + instancias.getSql().getNumConsecutivo("COPROLOGICO")[0];
            ...
            if (!instancias.getSql().agregarCoprologico(id, txtIdentificacion.getText(), txtNumeroOrden.getText(), txtRemitido.getText(), metodosGenerales.fecha(),
                    ...
                    teniaInfestacion, strongiloidesHuevos, strongiloidesInfestacion, larvasHuevos, larvasInfestacion, oxiurosHuevos, oxiurosInfestacion)) {
                metodos.msgError(this, "Hubo un problema al guardar");
                return;
            }

            if (!instancias.getSql().aumentarConsecutivo("COPROLOGICO", Integer.parseInt((String) instancias.getSql().getNumConsecutivo("COPROLOGICO")[0]) + 1)) {
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        if (!txtIdentificacion.getText().equals("")) {
            ...
            impresion.cargarRegistros(txtIdentificacion.getText(), "coprologico", instancias);
