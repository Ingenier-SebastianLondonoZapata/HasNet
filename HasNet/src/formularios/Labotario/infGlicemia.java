...
public class infGlicemia extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        lbNit10.setText("GLICEMIA EN AYUNAS");
        ...
        lbNit25.setFont(new java.awt.Font("Century Gothic", 0, 24)); // NOI18N
        lbNit25.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbNit25.setText("GLICEMIA");
        ...
        lbNit44.setText("Cordon umbilical: 45 a 96 mg/dl");
        ...
        lbNit45.setText("Prematuros: 20 a 60 mg/dl");
        ...
        lbNit46.setText("Recien nacidos: 30 a 60 mg/dl");
        ...
        lbNit47.setText("Recien nacidos > 1 dia: 50 a 80 mg/dl");
        ...
        lbNit48.setText("Recien nacidos 1 dias: 40 a 60 mg/dl");
        ...
        lbNit49.setText("Niños: 60 a 100 mg/dl");
        ...
        lbNit50.setText("Adultos: 70 a 105 mg/dl");
        ...
        lbNit51.setText("Mayores de 60 años: 80 a 115 mg/dl");
        ...
        lbNit52.setText("Mayores de 70 años: 83 a 110 mg/dl");
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGap(644, 644, 644)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lbNit46, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 281, Short.MAX_VALUE)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lbNit52, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            ...
                            .addComponent(lbNit50, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGap(3, 3, 3)
                        .addComponent(lbNit46, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(3, 3, 3)
...
//            txtRemitido.setText(metodos.fecha(Tercero.getNacimiento()));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (metodos.msgPregunta(this, "¿Desea continuar?") == 0) {
            ...
            String id = "GLICEMIA-" + instancias.getSql().getNumConsecutivo("GLICEMIA")[0];

            if (!instancias.getSql().agregarGlicemia(id, txtIdentificacion.getText(), txtNumeroOrden.getText(), txtRemitido.getText(), metodosGenerales.fecha(),
                    txtResultados.getText(), txtTecnica.getText(), txtObservaciones.getText())) {
                metodos.msgError(this, "Hubo un problema al guardar");
                return;
            }

            if (!instancias.getSql().aumentarConsecutivo("GLICEMIA", Integer.parseInt((String) instancias.getSql().getNumConsecutivo("GLICEMIA")[0]) + 1)) {
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        if (!txtIdentificacion.getText().equals("")) {
            ...
            impresion.cargarRegistros(txtIdentificacion.getText(), "glicemia", instancias);
