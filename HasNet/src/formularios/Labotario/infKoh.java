...
public class infKoh extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        rbtPiel = new javax.swing.JRadioButton();
        rbtCabello = new javax.swing.JRadioButton();
        rbtMano = new javax.swing.JRadioButton();
        rbtPie = new javax.swing.JRadioButton();
        ...
        txtResultados.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGap(351, 351, 351)
                .addComponent(cmbResultado, javax.swing.GroupLayout.PREFERRED_SIZE, 269, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addContainerGap()
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(cmbResultado, javax.swing.GroupLayout.DEFAULT_SIZE, 74, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        buttonGroup1.add(rbtPiel);
        rbtPiel.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        rbtPiel.setText("PIEL");
        rbtPiel.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rbtPielActionPerformed(evt);
            }
        });

        buttonGroup1.add(rbtCabello);
        rbtCabello.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        rbtCabello.setText("CABELLO");
        rbtCabello.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rbtCabelloActionPerformed(evt);
            }
        });

        buttonGroup1.add(rbtMano);
        rbtMano.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        rbtMano.setText("MANO");
        rbtMano.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rbtManoActionPerformed(evt);
            }
        });

        buttonGroup1.add(rbtPie);
        rbtPie.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        rbtPie.setText("PIE");
        rbtPie.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rbtPieActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(rbtPiel)
                .addGap(34, 34, 34)
                .addComponent(rbtCabello)
                .addGap(30, 30, 30)
                .addComponent(rbtMano)
                .addGap(18, 18, 18)
                .addComponent(rbtPie)
                .addGap(289, 289, 289))
        );
...
//            txtRemitido.setText(metodos.fecha(Tercero.getNacimiento()));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if (cmbResultado.getSelectedIndex() == 0) {
            metodos.msgError(this, "Seleccione el resultado");
            return;
        }
        ...
        if (metodos.msgPregunta(this, "¿Desea continuar?") == 0) {
            ...
            String id = "KOH-" + instancias.getSql().getNumConsecutivo("KOH")[0];

            String opcion = "";
            if (rbtCabello.isSelected()) {
                opcion = "CABELLO";
            } else if (rbtMano.isSelected()) {
                opcion = "MANO";
            } else if (rbtPie.isSelected()) {
                opcion = "PIE";
            } else if (rbtPiel.isSelected()) {
                opcion = "PIEL";
            }

            if (!instancias.getSql().agregarKoh(id, txtIdentificacion.getText(), txtNumeroOrden.getText(), txtRemitido.getText(), metodosGenerales.fecha(),
                    opcion, txtTecnica.getText(), txtObservaciones.getText(), txtResultados.getText(), cmbResultado.getSelectedItem().toString())) {
                metodos.msgError(this, "Hubo un problema al guardar");
                return;
            }

            if (!instancias.getSql().aumentarConsecutivo("KOH", Integer.parseInt((String) instancias.getSql().getNumConsecutivo("KOH")[0]) + 1)) {
            ...
            if (metodos.msgPregunta(this, "¿Desea imprimir?") == 0) {
                ...
                instancias.getReporte().ver_Examen(id, instancias.getInformacionEmpresa(), legal, pie, txtEdad.getText(), "koh");
            }
            btnLimpiarActionPerformed(evt);
        }
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        if (!txtIdentificacion.getText().equals("")) {
            ...
            impresion.cargarRegistros(txtIdentificacion.getText(), "koh", instancias);
    ...
    private void rbtPielActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbtPielActionPerformed

    }//GEN-LAST:event_rbtPielActionPerformed

    private void rbtCabelloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbtCabelloActionPerformed
        if (rbtCabello.isSelected()) {
    ...
    }//GEN-LAST:event_rbtCabelloActionPerformed

    private void rbtManoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbtManoActionPerformed

    }//GEN-LAST:event_rbtManoActionPerformed

    private void rbtPieActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbtPieActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_rbtPieActionPerformed
    ...
    public void reimprimir(String consecutivo) {
        ...
        instancias.getReporte().ver_Examen(consecutivo, instancias.getInformacionEmpresa(), legal, pie, txtEdad.getText(), "koh");
    }
    ...
    private javax.swing.JRadioButton rbtCabello;
    private javax.swing.JRadioButton rbtMano;
    private javax.swing.JRadioButton rbtPie;
    private javax.swing.JRadioButton rbtPiel;
