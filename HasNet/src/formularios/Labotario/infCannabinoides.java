...
public class infCannabinoides extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        lbNit10.setText("CANNABINOIDES (MARIHUANA)");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (metodos.msgPregunta(this, "¿Desea continuar?") == 0) {
            ...
            String id = "CANNABINOIDES-" + instancias.getSql().getNumConsecutivo("CANNABINOIDES")[0];

            if (!instancias.getSql().agregarCannabinoides(id, txtIdentificacion.getText(), txtNumeroOrden.getText(), "", metodosGenerales.fecha(),
                    cmbResultado.getSelectedItem().toString(), txtTecnica.getText(), txtObservaciones.getText())) {
                metodos.msgError(this, "Hubo un problema al guardar");
                return;
            }

            if (!instancias.getSql().aumentarConsecutivo("CANNABINOIDES", Integer.parseInt((String) instancias.getSql().getNumConsecutivo("CANNABINOIDES")[0]) + 1)) {
            ...
            if (metodos.msgPregunta(this, "¿Desea imprimir?") == 0) {
                ...
                instancias.getReporte().ver_Examen(id, instancias.getInformacionEmpresa(), legal, pie, txtEdad.getText(), "cannabinoides");
            }
            btnLimpiarActionPerformed(evt);
        }
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        if (!txtIdentificacion.getText().equals("")) {
            ...
            impresion.cargarRegistros(txtIdentificacion.getText(), "cannabinoides", instancias);
    ...
    public void reimprimir(String consecutivo) {
        ...
        instancias.getReporte().ver_Examen(consecutivo, instancias.getInformacionEmpresa(), legal, pie, txtEdad.getText(), "cannabinoides");
    }
