...
public class infHemoglobina extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        lbNit10.setText("HEMOGLOBINA GLICOSILADA A1c (HbA1c)");
        ...
        lbRazon5.setText("Solicitado por:");
        ...
        lbNit25.setText("HEMOGLOBINA GLICOSILADA A1c");
        ...
        lbNit44.setText("No diabético: 4.0% - 5.6%");
        ...
        lbNit45.setText("Pre diabético: 5.7% - 6.4%");
        ...
        lbNit46.setText("Diabético: mayor a 6.5%");
        ...
        lbNit48.setText("Diabético controlado: menor de 7.0%");
        ...
        lbNit49.setText("Diabético no controlado: mayor de 7.0%");
        ...
        lbNit26.setText("HEMOGLOBINA GLICOSILADA A1c (HbA1c)");
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(lbNit45, javax.swing.GroupLayout.DEFAULT_SIZE, 281, Short.MAX_VALUE)))
                    .addGroup(jPanel4Layout.createSequentialGroup()
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(lbNit49, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE))
...
//            txtRemitido.setText(metodos.fecha(Tercero.getNacimiento()));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (metodos.msgPregunta(this, "¿Desea continuar?") == 0) {
            ...
            String id = "HEMOGLOBINA-" + instancias.getSql().getNumConsecutivo("HEMOGLOBINA")[0];

            if (!instancias.getSql().agregarHemoglobina(id, txtIdentificacion.getText(), txtNumeroOrden.getText(), txtRemitido.getText(), metodosGenerales.fecha(),
                    txtResultados.getText(), txtTecnica.getText(), txtObservaciones.getText())) {
                metodos.msgError(this, "Hubo un problema al guardar");
                return;
            }

            if (!instancias.getSql().aumentarConsecutivo("HEMOGLOBINA", Integer.parseInt((String) instancias.getSql().getNumConsecutivo("HEMOGLOBINA")[0]) + 1)) {
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        if (!txtIdentificacion.getText().equals("")) {
            ...
            impresion.cargarRegistros(txtIdentificacion.getText(), "hemoglobina", instancias);
