...
public class infHemograma extends javax.swing.JInternalFrame {
    ...
    public infHemograma() {
        ...
        txtEdad.setText("NOTAP-" + instancias.getSql().getNumConsecutivo("NOTAP")[0]);
    ...
    private void initComponents() {
        ...
        lbNit10.setText("HEMOGRAMA COMPLETO TIPO IV SEMIAUTOMATICO");
        ...
        tblTabla1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"GLOBULOS ROJOS", null, "3.5 - 5.0mm3"},
                {"HEMOGLOBINA", null, "VN: 12 - 15%"},
                {"HEMATOCRITO", null, "VN: 37 - 47%"},
                {"SEDIMENTACIÓN", null, "VN: 1 - 20 mm/h"}
            },
            new String [] {
        ...
        tblTabla3.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"RECUENTO", null, "150000 - 450000.mm3"},
                {"MORFOLOGIA", null, null}
            },
            new String [] {
                "PLAQUETAS", "RESULTADO", "REFERENCIAS"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, true, false
        ...
        jScrollPane5.setViewportView(tblTabla3);
        ...
        tblTabla4.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        tblTabla4.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"LEUCOCITOS", null, "VN: 3600 - 10000.mm3"},
                {"NEUTROFILOS", null, "VN: 50 - 70 %"},
                {"BANDAS", null, "VN: 0 - 1 %"},
                {"LINFOCITOS", null, "VN: 20 - 40 %"},
                {"MONOCITOS", null, "VN: 2 - 10 %"},
                {"EOSINOFILOS", null, "VN: 1,0 - 4 %"},
                {"BASOFILOS", null, "VN: 0 - 2 %"},
                {"BLASTOS", null, "VN: 0 - 5 %"}
            },
            new String [] {
                "LEUCOGRAMA", "RESULTADO", "GRADO DE INFESTACIÓN"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, true, false
        ...
        tblTabla4.setRowHeight(25);
        tblTabla4.getTableHeader().setReorderingAllowed(false);
        jScrollPane6.setViewportView(tblTabla4);
        if (tblTabla4.getColumnModel().getColumnCount() > 0) {
            tblTabla4.getColumnModel().getColumn(0).setMinWidth(250);
            tblTabla4.getColumnModel().getColumn(0).setPreferredWidth(250);
            tblTabla4.getColumnModel().getColumn(0).setMaxWidth(250);
        }
        ...
        pnlFormularioLayout.setHorizontalGroup(
            ...
            .addGroup(pnlFormularioLayout.createSequentialGroup()
                ...
                .addGroup(pnlFormularioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel10, javax.swing.GroupLayout.PREFERRED_SIZE, 951, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//            txtRemitido.setText(metodos.fecha(Tercero.getNacimiento()));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        tblTabla4.removeEditor();

        if (metodos.msgPregunta(this, "¿Desea continuar?") == 0) {

            String id = "HEMOGRAMA-" + instancias.getSql().getNumConsecutivo("HEMOGRAMA")[0];

            String globulosRojos;
            try {
                globulosRojos = tblTabla1.getValueAt(0, 1).toString();
            } catch (Exception e) {
                globulosRojos = "";
            }
            ...
            String hemoglobina;
            try {
                hemoglobina = tblTabla1.getValueAt(1, 1).toString();
            } catch (Exception e) {
                hemoglobina = "";
            }
            ...
            String hematocrito;
            try {
                hematocrito = tblTabla1.getValueAt(2, 1).toString();
            } catch (Exception e) {
                hematocrito = "";
            }

            String sedimentacion;
            try {
                sedimentacion = tblTabla1.getValueAt(3, 1).toString();
            } catch (Exception e) {
                sedimentacion = "";
            }
            ...
            String anisocitosis;
            try {
                anisocitosis = tblTabla2.getValueAt(0, 1).toString();
            } catch (Exception e) {
                anisocitosis = "";
            }
            ...
            String macrocitosis;
            try {
                macrocitosis = tblTabla2.getValueAt(1, 1).toString();
            } catch (Exception e) {
                macrocitosis = "";
            }
            ...
            String microcitosis;
            try {
                microcitosis = tblTabla2.getValueAt(2, 1).toString();
            } catch (Exception e) {
                microcitosis = "";
            }
            ...
            String hipocromia;
            try {
                hipocromia = tblTabla2.getValueAt(3, 1).toString();
            } catch (Exception e) {
                hipocromia = "";
            }

            String policromatofilia;
            try {
                policromatofilia = tblTabla2.getValueAt(4, 1).toString();
            } catch (Exception e) {
                policromatofilia = "";
            }

            String poikilocitosis;
            try {
                poikilocitosis = tblTabla2.getValueAt(5, 1).toString();
            } catch (Exception e) {
                poikilocitosis = "";
            }
            ...
            String recuento;
            try {
                recuento = tblTabla3.getValueAt(0, 1).toString();
            } catch (Exception e) {
                recuento = "";
            }
            ...
            String morfologia;
            try {
                morfologia = tblTabla3.getValueAt(1, 1).toString();
            } catch (Exception e) {
                morfologia = "";
            }
            ...
            String leucocitos;
            try {
                leucocitos = tblTabla4.getValueAt(0, 1).toString();
            } catch (Exception e) {
                leucocitos = "";
            }
            ...
            String neutrofilos;
            try {
                neutrofilos = tblTabla4.getValueAt(1, 1).toString();
            } catch (Exception e) {
                neutrofilos = "";
            }
            ...
            String bandas;
            try {
                bandas = tblTabla4.getValueAt(2, 1).toString();
            } catch (Exception e) {
                bandas = "";
            }
            ...
            String linfocitos;
            try {
                linfocitos = tblTabla4.getValueAt(3, 1).toString();
            } catch (Exception e) {
                linfocitos = "";
            }
            ...
            String monocitos;
            try {
                monocitos = tblTabla4.getValueAt(4, 1).toString();
            } catch (Exception e) {
                monocitos = "";
            }
            ...
            String eosinofilos;
            try {
                eosinofilos = tblTabla4.getValueAt(5, 1).toString();
            } catch (Exception e) {
                eosinofilos = "";
            }
            ...
            String basofilos;
            try {
                basofilos = tblTabla4.getValueAt(6, 1).toString();
            } catch (Exception e) {
                basofilos = "";
            }
            ...
            String blastos;
            try {
                blastos = tblTabla4.getValueAt(7, 1).toString();
            } catch (Exception e) {
                blastos = "";
            }

            if (!instancias.getSql().agregarHemograma(id, txtIdentificacion.getText(), txtNumeroOrden.getText(), txtRemitido.getText(), metodosGenerales.fecha(),
                    "", txtTecnica.getText(), txtObservaciones.getText(), globulosRojos, hemoglobina, hematocrito, sedimentacion, anisocitosis, macrocitosis, microcitosis,
                    hipocromia, policromatofilia, poikilocitosis, recuento, morfologia, leucocitos, neutrofilos, bandas, linfocitos, monocitos, eosinofilos, basofilos, blastos)) {
                metodos.msgError(this, "Hubo un problema al guardar");
                return;
            }

            if (!instancias.getSql().aumentarConsecutivo("HEMOGRAMA", Integer.parseInt((String) instancias.getSql().getNumConsecutivo("HEMOGRAMA")[0]) + 1)) {
            ...
            if (metodos.msgPregunta(this, "¿Desea imprimir?") == 0) {
                ...
                instancias.getReporte().ver_Examen(id, instancias.getInformacionEmpresa(), legal, pie, txtEdad.getText(), "hemograma");
            }
            btnLimpiarActionPerformed(evt);
        }
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        if (!txtIdentificacion.getText().equals("")) {
            ...
            impresion.cargarRegistros(txtIdentificacion.getText(), "hemograma", instancias);
    ...
    private void btnLimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLimpiarActionPerformed
        ...
        tblTabla4.setValueAt("", 0, 1);
        tblTabla4.setValueAt("", 1, 1);
        tblTabla4.setValueAt("", 2, 1);
        tblTabla4.setValueAt("", 3, 1);
        tblTabla4.setValueAt("", 4, 1);
        tblTabla4.setValueAt("", 5, 1);
        tblTabla4.setValueAt("", 6, 1);
        tblTabla4.setValueAt("", 7, 1);
    ...
    public void reimprimir(String consecutivo) {
        ...
        instancias.getReporte().ver_Examen(consecutivo, instancias.getInformacionEmpresa(), legal, pie, txtEdad.getText(), "hemograma");
    }
