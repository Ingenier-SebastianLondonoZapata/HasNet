...
public class buscHorasAgenda extends javax.swing.JDialog {
    ...
    public buscHorasAgenda(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void setInstancia(Instancias instancia) {
        ...
        String usuario = instancias.getInfoAgenda().getaCargo();
        Object[][] agendas = instancias.getSql().getRegistrosAgendas(metodos.fechaConsulta(fecha), usuario);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscHorasAgenda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                buscHorasAgenda dialog = new buscHorasAgenda(new javax.swing.JFrame(), true);
