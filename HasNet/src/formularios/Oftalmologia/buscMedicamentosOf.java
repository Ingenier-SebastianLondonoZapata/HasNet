...
public class buscMedicamentosOf extends javax.swing.JDialog {

    DefaultTableModel modelo;
    TableRowSorter modeloOrdenado;
    Instancias instancias;

    public buscMedicamentosOf(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        btnEste1.setText("Guardar Nuevo");
    ...
    private void btnEste1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEste1ActionPerformed
        String aux = instancias.getSql().getDatosMedicamentos2(txtId.getText());
        if(aux == null){
            if(!instancias.getSql().agregarMedicamento(txtId.getText())){
                JOptionPane.showMessageDialog(null, "Hubo un error al ingresar el medicamento");
                return;
            }
            JOptionPane.showMessageDialog(null, "Medicamento ingresado con exito");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscMedicamentosOf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                buscMedicamentosOf dialog = new buscMedicamentosOf(new javax.swing.JFrame(), true);
