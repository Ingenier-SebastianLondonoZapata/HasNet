...
public class buscAyudaDiagnostico extends javax.swing.JDialog {
    ...
    public buscAyudaDiagnostico(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void cargarAyudas() {
        ...
        tblRegistros.getColumnModel().getColumn(0).setCellRenderer(new WordWrapCellRenderer());
    }
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnEste2, javax.swing.GroupLayout.DEFAULT_SIZE, 29, Short.MAX_VALUE)
                    .addComponent(txtId))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnEste2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEste2ActionPerformed
        ...
        if (aux == null) {
            if (metodos.msgPregunta(null, "¿Agregar la ayuda diagnostica?") == 0) {
                if (!instancias.getSql().agregarAyudaDiagnostico(txtId.getText())) {
                    metodos.msgError(null, "Error al agregar la ayuda diagnostica");
                    return;
                }
                metodos.msgExito(null, "Ayuda agregada con exito");
                cargarAyudas();
    ...
    private void btnEsteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEsteActionPerformed
        this.dispose();
        instancias.getAyudaDiagnostica().cargarTabla((String) tblRegistros.getValueAt(tblRegistros.getSelectedRow(), 0));
...
//    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscAyudaDiagnostico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                buscAyudaDiagnostico dialog = new buscAyudaDiagnostico(new javax.swing.JFrame(), true);
