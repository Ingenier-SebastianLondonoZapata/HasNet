...
public class infReportesMedico extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { " ", "Reporte de ordenes", "Reporte de formulas", "Certificado estudiante", "Certificado medico", "Certificado OyS" }));
    ...
    private void mostrarReportes() {
        ...
        if (jComboBox1.getSelectedIndex() == 1) {
            if (instancias.getUsuarioLog().isReporteOrdenes()) {
                infRepOrdenesMedicas pnlReporte = new infRepOrdenesMedicas();
                instancias.setRepMedico(pnlReporte);
        ...
        if (jComboBox1.getSelectedIndex() == 2) {
            if (instancias.getUsuarioLog().isReporteFormulas()) {
                infRepFormulas pnlReporte = new infRepFormulas();
                instancias.setRepFormulaMedica(pnlReporte);
                pnlReporte.setSize(jPanel1.getSize());
                jPanel1.removeAll();
                jPanel1.add(pnlReporte, CENTER_ALIGNMENT);
                jPanel1.revalidate();
        ...
        if (jComboBox1.getSelectedIndex() == 3) {
            if (instancias.getUsuarioLog().isCertificadoEstudiante()) {
                infCertificadoMedicoEstudiante pnlReporte = new infCertificadoMedicoEstudiante();
                instancias.setCertificadoMedicoEstudiante(pnlReporte);
                pnlReporte.setSize(jPanel1.getSize());
                jPanel1.removeAll();
                jPanel1.add(pnlReporte, CENTER_ALIGNMENT);
                jPanel1.revalidate();
        ...
        if (jComboBox1.getSelectedIndex() == 4) {
            if (instancias.getUsuarioLog().isCertificadoMedico()) {
                infCertificadoMedico pnlReporte = new infCertificadoMedico();
                instancias.setCertificadoMedico(pnlReporte);
                pnlReporte.setSize(jPanel1.getSize());
                jPanel1.removeAll();
                jPanel1.add(pnlReporte, CENTER_ALIGNMENT);
                jPanel1.revalidate();
        ...
        if (jComboBox1.getSelectedIndex() == 5) {
            if (instancias.getUsuarioLog().isCertificadoOyS()) {
                infCertificadoMedicoOys pnlReporte = new infCertificadoMedicoOys();
                instancias.setCertificadoMedicoOys(pnlReporte);
                pnlReporte.setSize(jPanel1.getSize());
                jPanel1.removeAll();
                jPanel1.add(pnlReporte, CENTER_ALIGNMENT);
                jPanel1.revalidate();
