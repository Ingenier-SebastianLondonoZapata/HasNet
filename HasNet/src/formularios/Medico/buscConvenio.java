...
public class buscConvenio extends javax.swing.JDialog {
    ...
    public buscConvenio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnEsteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEsteActionPerformed
        if (opc == null) {
            ...
            instancias.getClientes().cargarConvenio((String) tblRegistros.getValueAt(tblRegistros.getSelectedRow(), 0));
        }
        this.dispose();
    ...
    public void setInstancia(Instancias instancia) {
        ...
        tblRegistros.setModel(instancias.getSql().getRegistrosConvenio());
        ...
        for (int i = 0; i < tblRegistros.getRowCount(); i++) {
            ModeloContacto nodo = instancias.getSql().getDatosTercero(tblRegistros.getValueAt(i, 0).toString());
            tblRegistros.setValueAt(nodo.getId(), i, 0);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscConvenio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                buscConvenio dialog = new buscConvenio(new javax.swing.JFrame(), true);
