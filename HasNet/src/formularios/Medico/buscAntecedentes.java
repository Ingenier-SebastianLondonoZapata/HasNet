...
public class buscAntecedentes extends javax.swing.JDialog {

    DefaultTableModel modelo;
    TableRowSorter modeloOrdenado;
    Instancias instancias;

    public buscAntecedentes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
     ...
     * @param instancia
     */
    public void setInstancia(Instancias instancia, int tipo) {
        instancias = instancia;

        tblRegistros.setModel(instancias.getSql().getRegistrosAntecedentes(tipo));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscAntecedentes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                buscAntecedentes dialog = new buscAntecedentes(new javax.swing.JFrame(), true);
