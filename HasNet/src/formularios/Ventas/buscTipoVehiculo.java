...
public class buscTipoVehiculo extends javax.swing.JDialog {
    ...
    public buscTipoVehiculo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Buscador tipos de vehiculos...");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnEste, javax.swing.GroupLayout.DEFAULT_SIZE, 38, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void btnEste1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEste1ActionPerformed
        if (txtId.getText().equals("")) {
            metodos.msgError(null, "Debe ingresar el tipo");
            return;
        }

        String aux = instancias.getSql().getDatosTipoVehiculo(txtId.getText().toUpperCase());
        if (aux == null) {
            if (metodos.msgPregunta(null, "¿Agregar como " + txtId.getText().toUpperCase() + "? ") == 0) {
                if (!instancias.getSql().agregarTipoVehiculo(txtId.getText().toUpperCase())) {
                    metodos.msgError(null, "Hubo un error al ingresar el tipo de vehiculo");
                    return;
                }
                metodos.msgExito(null, "Tipo ingresado con exito");
    ...
    public void setInstancia(Instancias instancia) {
        ...
        tblRegistros.setModel(instancias.getSql().getRegistrosTipoVehiculos());
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(buscTipoVehiculo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                buscTipoVehiculo dialog = new buscTipoVehiculo(new javax.swing.JFrame(), true);
