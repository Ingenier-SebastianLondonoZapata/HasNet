...
public class infMesa extends javax.swing.JInternalFrame {
    ...
    public infMesa() {
        ...
        pnlFactura = new VistaFactura("mesa");
    ...
    public void setSelected(boolean selected){
        try {
            ...
            Logger.getLogger(infMesa.class.getName()).log(Level.SEVERE, null, ex);
        }
