...
public class infCuentaCobro extends javax.swing.JInternalFrame {
    ...
    public infCuentaCobro() {
        ...
        pnlFactura = new VistaFactura("cuentaCobro");
    ...
    public void setSelected(boolean selected) {
        try {
            ...
            Logger.getLogger(infCuentaCobro.class.getName()).log(Level.SEVERE, null, ex);
        }
