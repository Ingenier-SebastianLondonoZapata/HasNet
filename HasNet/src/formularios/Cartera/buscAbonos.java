...
public class buscAbonos extends javax.swing.JDialog {

    DefaultTableModel modelo;
    TableRowSorter modeloOrdenado;
    Instancias instancias;
    private String contrato;
    public buscAbonos(java.awt.Frame parent, boolean modal, String contrato) {
        super(parent, modal);
        initComponents();
...
//        instancias.getAbonos().anularAbono();
        this.dispose();
    ...
    public void setInstancia(Instancias instancia) {
        ...
        tblRegistros.setModel(instancias.getSql().getRegistrosAbonosRealizados(contrato));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscAbonos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                buscAbonos dialog = new buscAbonos(new javax.swing.JFrame(), true,"1");
