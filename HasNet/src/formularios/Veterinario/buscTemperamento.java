...
public class buscTemperamento extends javax.swing.JDialog {
    ...
    public buscTemperamento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.tipo = tipo;
    ...
    private void initComponents() {
        ...
        setTitle("Buscador de temperamentos...");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(btnEste, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnEste1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEste1ActionPerformed
        ...
        if (aux == null) {
            if (metodos.msgPregunta(null, "¿Agregar el temperamento?") == 0) {
                if (!instancias.getSql().agregarTemperamento(txtId.getText().toUpperCase())) {
                    metodos.msgError(null, "Error al guardar");
                    return;
                }
                metodos.msgExito(null, "Temperamento ingresado con exito");
    ...
    public void setInstancia(Instancias instancia) {
        ...
        tblRegistros.setModel(instancias.getSql().getRegistrosTemperamento());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscTemperamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                buscTemperamento dialog = new buscTemperamento(new javax.swing.JFrame(), true);
