...
public class infQuirurgica extends javax.swing.JInternalFrame {
    ...
    public infQuirurgica() {
        ...
        txtId.setText("" + instancias.getSql().getNumConsecutivo("QUIR")[0]);
    ...
    private void initComponents() {
        ...
        lbFacturaNo.setText("Quirurgica");
        ...
        lbRazon9.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N
        lbRazon9.setText("Tipo de procedimiento:");

        txtPrescripcion.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        ...
        lbRazon14.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        ...
        jPanel14Layout.setVerticalGroup(
            ...
            .addGroup(jPanel14Layout.createSequentialGroup()
                ...
                .addGroup(jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtPrescripcion, javax.swing.GroupLayout.DEFAULT_SIZE, 28, Short.MAX_VALUE)
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(scrFormulario, javax.swing.GroupLayout.DEFAULT_SIZE, 961, Short.MAX_VALUE)
        );
        ...
        getAccessibleContext().setAccessibleName("Quirurgica...");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (metodos.msgPregunta(this, "¿Desea continuar?") == 0) {
            ...
            String id = "" + instancias.getSql().getNumConsecutivo("QUIR")[0];

            if (!instancias.getSql().agregarQuirurgica(id, instancias.getHistoria().getConsulta(), metodosGenerales.fecha(),
                    instancias.getUsuario(), txtPrescripcion.getText(), txtObservacion.getText())) {
                metodos.msgError(this, "Hubo un problema al guardar la historia quirurgica");
                return;
            }

            //CAMBIAR CONSECUTIVO FORMULA MEDICA
            instancias.getSql().aumentarConsecutivo("QUIR", Integer.parseInt((String) instancias.getSql().getNumConsecutivo("QUIR")[0]) + 1);

            metodos.msgExito(this, "Quirurgica registrada con éxito");
            ...
            try {
                ...
                Logger.getLogger(infQuirurgica.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void btnBuscTerceros2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscTerceros2ActionPerformed
        ...
        reimpresion.cargarRegistros(txtHistoria.getText(), "quirurgica", instancias);
...
//            txtEdad.setText(metodosGenerales.calcularEdad(Mascota.getEdad()).toString());
        ...
        txtFecha.setText(metodosGenerales.fecha());
        txtId.setText("" + instancias.getSql().getNumConsecutivo("QUIR")[0]);
        instancias.getMenu().cambiarTitulo("QUIRURGICA");
    }
