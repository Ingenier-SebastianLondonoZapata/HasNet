...
public class buscEgresos extends javax.swing.JDialog {
    ...
    public buscEgresos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void cargarMedicamentos() {
        ...
        tblRegistros.setModel(instancias.getSql().getRegistrosCodigosEgresos());
        ...
        for (int i = 0; i < tblRegistros.getRowCount(); i++) {
            ...
            try {
                id = tblRegistros.getValueAt(i, 0).toString();
            } catch (Exception e) {
            }
    ...
    private void initComponents() {
        ...
        setTitle("Buscador de conceptos...");
        ...
        rdCodigo.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        rdCodigo.setText("Codigo");
        rdCodigo.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                rdCodigoItemStateChanged(evt);
            }
        });
        ...
        buttonGroup1.add(rdDescripcion);
        rdDescripcion.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        rdDescripcion.setSelected(true);
        rdDescripcion.setText("Descripción");
        rdDescripcion.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                rdDescripcionItemStateChanged(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtId)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(rdDescripcion, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(10, 10, 10)
    ...
    private void rdDescripcionItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_rdDescripcionItemStateChanged

    }//GEN-LAST:event_rdDescripcionItemStateChanged

    private void rdCodigoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_rdCodigoItemStateChanged

    }//GEN-LAST:event_rdCodigoItemStateChanged
...
//    }
    public void noEncontrado(String codigo) {
        ...
        modeloOrdenado.setRowFilter(RowFilter.regexFilter("(?i)" + codigo, 2));
        try {
            tblRegistros.getSelectionModel().setSelectionInterval(0, 0);
        } catch (ArrayIndexOutOfBoundsException exp) {
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscEgresos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                buscEgresos dialog = new buscEgresos(new javax.swing.JFrame(), true);
