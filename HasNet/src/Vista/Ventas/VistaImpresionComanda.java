...
public class VistaImpresionComanda extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaImpresionComanda.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VistaImpresionComanda dialog = new VistaImpresionComanda(new javax.swing.JFrame(), true, null, "");
