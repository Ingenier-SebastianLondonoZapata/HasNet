...
public class VistaReporteIvas extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lbNit8.setFont(new java.awt.Font("Century Gothic", 0, 24)); // NOI18N
        lbNit8.setText("Fecha inicial:");

        lbNit9.setFont(new java.awt.Font("Century Gothic", 0, 24)); // NOI18N
        ...
        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Imprimir", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Century Gothic", 0, 14))); // NOI18N
        ...
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lbNit11, javax.swing.GroupLayout.DEFAULT_SIZE, 33, Short.MAX_VALUE)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        System.out.println("Consulta Rep Ventas: " + sql);
        ...
        if (valores.equals("")) {
            System.out.println("No tiene valores acomulados");
        } else {
            while (tblResultados.getRowCount() > 0) {
                modelo.removeRow(0);
            }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        if (metodos.msgPregunta(null, "¿Esta seguro?") == 0) {
            ...
            if (dtInicio.getText().equals(dtFinal.getText())) {
                enca = "Ivas de venta del " + ini;
            } else {
                enca = "Ivas de venta entre el " + ini + " y el " + fin;
            }

            String tipo = "";
            if (btnExcel.isSelected()) {
                if (rbImpo.isSelected()) {
                    instancias.setRutaAguardar(metodos.obtenerRuta(null, "Reporte de Impoconsumo de venta" + metodosGenerales.dia() + " de " + metodosGenerales.mesEnPalabra() + " del " + metodosGenerales.anho()));
                    tipo = "xls";
                } else {
                    instancias.setRutaAguardar(metodos.obtenerRuta(null, "Reporte de Iva de venta" + metodosGenerales.dia() + " de " + metodosGenerales.mesEnPalabra() + " del " + metodosGenerales.anho()));
                    tipo = "xls";
                }
            }
