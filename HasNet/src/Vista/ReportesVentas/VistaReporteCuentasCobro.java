...
public class VistaReporteCuentasCobro extends javax.swing.JPanel {

    metodosGenerales metodos = new metodosGenerales();
    private Instancias instancias;

    public VistaReporteCuentasCobro() {
        initComponents();
    ...
    private void initComponents() {
        ...
        cmbPeriodicidad1 = new javax.swing.JComboBox();
        ...
        cmbTerminal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "MENSUAL", "ANUAL" }));

        lbTerminal.setFont(new java.awt.Font("Century Gothic", 1, 16)); // NOI18N
        lbTerminal.setText("Periodicidad:");
        ...
        cmbPeriodicidad1.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(cmbPeriodicidad1, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel8Layout.setVerticalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGap(39, 39, 39)
                .addComponent(cmbPeriodicidad1, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void btnAggTerminalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAggTerminalActionPerformed
        for (int i = 0; i < cmbPeriodicidad1.getItemCount(); i++) {
            if (cmbPeriodicidad1.getItemAt(i).equals(cmbTerminal.getSelectedItem())) {
                metodos.msgError(null, "Ya has ingresado esta periodicidad");
                return;
            }
        }
        cmbPeriodicidad1.addItem(cmbTerminal.getSelectedItem());
    ...
    private void btnRemTerminalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemTerminalActionPerformed
        if (cmbPeriodicidad1.getItemCount() == 0) {
            metodos.msgError(null, "No hay ninguna terminal seleccionada");
            return;
        }
        cmbPeriodicidad1.removeItem(cmbPeriodicidad1.getSelectedItem());
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        if (metodos.msgPregunta(null, "¿Esta seguro?") == 0) {
            ...
            if (cmbPeriodicidad1.getItemCount() > 0) {
                ...
                for (int i = 0; i < cmbPeriodicidad1.getItemCount(); i++) {
                    sql = sql + " periodicidad ='" + cmbPeriodicidad1.getItemAt(i) + "' OR";
                }
            ...
            if (dtInicio.getText().equals(dtFinal.getText())) {
                enca = "Plantillas del " + ini;
            } else {
                enca = "Plantillas entre el " + ini + " y el " + fin;
            }
            ...
            if (btnExcel.isSelected()) {
                instancias.setRutaAguardar(metodos.obtenerRuta(null, "Reporte de plantillas corto " + metodosGenerales.dia() + " de " + metodosGenerales.mesEnPalabra() + " del " + metodosGenerales.anho()));
                tipo = "xls";
            }

            instancias.getReporte().ver_RepPlantillas2(sql, enca, tipo);
        }
        ...
        if (metodos.msgPregunta(null, "¿Esta seguro?") == 0) {
            ...
            if (instancias.getUsuario().equals("ADMIN")) {
                if (cmbPeriodicidad1.getItemCount() > 0) {
                    ...
                    for (int i = 0; i < cmbPeriodicidad1.getItemCount(); i++) {
                        sql = sql + " terminal='" + cmbPeriodicidad1.getItemAt(i) + "' OR";
                    }
            ...
            if (btnExcel.isSelected()) {
                tipo = "xls";
                instancias.setRutaAguardar(metodos.obtenerRuta(null, "Reporte de plantillas " + metodosGenerales.dia() + " de " + metodosGenerales.mesEnPalabra() + " del " + metodosGenerales.anho()));
            }

            instancias.getReporte().ver_RepPlantillas(sql, enca, tipo);
        }
    ...
    private javax.swing.JComboBox cmbPeriodicidad1;
