...
import formularios.Tesoreria.dlgMovimientosPendientes;
...
//            cargarTabla();
    ...
    private void initComponents() {
        ...
        btnGuardar2.setText("GUARDAR BASE");
        ...
        btnGuardar1.setText("GUARDAR RECOGIDA");
        ...
        pnlDetalleCuadreCajaLayout.setHorizontalGroup(
            ...
            .addGroup(pnlDetalleCuadreCajaLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(pnlDetalleCuadreCajaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlDetalleCuadreCajaLayout.createSequentialGroup()
                        .addGroup(pnlDetalleCuadreCajaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(pnlDetalleCuadreCajaLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(cmbUsuarios, javax.swing.GroupLayout.PREFERRED_SIZE, 235, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(18, 18, 18)
                        .addComponent(btnGuardar2, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnReimprimir1, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnGuardar1, javax.swing.GroupLayout.PREFERRED_SIZE, 223, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        pnlDetalleCuadreCajaLayout.setVerticalGroup(
            ...
            .addGroup(pnlDetalleCuadreCajaLayout.createSequentialGroup()
                ...
                .addGroup(pnlDetalleCuadreCajaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlDetalleCuadreCajaLayout.createSequentialGroup()
                        .addGroup(pnlDetalleCuadreCajaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(lbNit18, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(pnlDetalleCuadreCajaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlDetalleCuadreCajaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(btnGuardar2, javax.swing.GroupLayout.PREFERRED_SIZE, 57, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(btnReimprimir1, javax.swing.GroupLayout.PREFERRED_SIZE, 57, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtAbonos, javax.swing.GroupLayout.DEFAULT_SIZE, 135, Short.MAX_VALUE))
                    .addGroup(jPanel7Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                .addGap(5, 5, 5)
                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtGastosDelDia, javax.swing.GroupLayout.DEFAULT_SIZE, 138, Short.MAX_VALUE)
            ...
            .addGroup(pnlTotalizadosCuaddreCajaLayout.createSequentialGroup()
                ...
                .addGroup(pnlTotalizadosCuaddreCajaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlTotalizadosCuaddreCajaLayout.createSequentialGroup()
                        .addGroup(pnlTotalizadosCuaddreCajaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(pnlControl, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(lbNit12, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(lbConsecutivo, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(pnlTotalizadosCuaddreCajaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jPanel4, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jTabbedPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 1337, Short.MAX_VALUE)
        );
...
//        }
        if (metodos.msgPregunta(this, "¿Desea continuar?") == 0) {
            ...
            if (big.getMoneda(tarjetaPend.getText()).compareTo(BigDecimal.ZERO) > 0) {
                System.out.println("entro a guardar en banco");
            ...
            if (instancias.getUsuario().equals("ADMIN")) {
                ...
                System.out.println("no puso ninguna bandera mero pato");
                Object[] letras = {"Cuadre de caja del " + dtInicio.getText(), instancias.getUsuario(),
                    metodos.fechaConsulta(metodosGenerales.fechaHora()), "ENTRADA"};
                Object[] valores = {big.getMoneda(efectivoPend.getText())};

                instancias.getSql().agregarMovimientoBancoPendiente(letras, valores);
                System.out.println(" mero pato");
            }
    ...
    public void calcularTotal() {
        if (calcular || instancias.isMostrarInformacionCuadre()) {
            ...
            BigDecimal total = big.getMoneda(efectivoPend.getText()).add(big.getMoneda(chequePend.getText())
                    .add(big.getMoneda(tarjetaPend.getText())).add(big.getMoneda(ncPend.getText())))
                    .add(big.getMoneda(recogidaPend.getText())).add(big.getMoneda(txtGastosDelDia.getText()));
            txtTotal.setText(big.setMoneda(total));

            BigDecimal sumCuadre = big.getMoneda(txtEfectivoSistema.getText()).add(big.getMoneda(txtChequeSistema.getText())).add(big.getMoneda(txtTarjetaSistema.getText())).
                    add(big.getMoneda(txtNcSistema.getText())).add(big.getMoneda(txtCuotasIniciales.getText())).add(big.getMoneda(txtTotalPropinas.getText()))
                    .add(big.getMoneda(txtBaseSistema.getText()));
