...
public class ndCompra {
    ...
    private String seguro, flete, otros, ingreso, producto, descripcion, plu, bodega, tienda, ref, rOri, marca, tipo,
            empaque, cdp, cmb, tCmb, kg, tKg, usuario;
    private String tipoDescuento, undMedida, composicion, color, precio1, precio2, precio3; //NUMEROS
    private String valor, total, iva, subtotal, descuento, valorPlu, impoconsumo; //NUMEROS
