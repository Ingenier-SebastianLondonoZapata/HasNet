package clases.Egresos;

public class ndEgreso {

    private String id, nit, razon, telefono, direccion, cred1, cred2, deb1, deb2, fecha, documento, usuario, terminal, estado, tipo, modeloContable;
    private String total, cheque, banco, efectivo, subtotal, iva, ingresoAsociado, egreso;
    ...
    public void setDeb1(String deb1) {
        this.deb1 = deb1;
    }

    public String getDeb2() {
        return deb2;
    }

    public void setDeb2(String deb2) {
        this.deb2 = deb2;
    }
