...
public final class AlertList extends javax.swing.JDialog {
     ...
     */
    public AlertList(java.awt.Frame parent, boolean modal, String message, List<Object> listadoDetalles) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertList dialog = new AlertList(new javax.swing.JFrame(), true, "", null);
