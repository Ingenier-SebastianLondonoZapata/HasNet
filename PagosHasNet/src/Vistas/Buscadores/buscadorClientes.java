...
public class buscadorClientes extends javax.swing.JDialog {

    DefaultTableModel modelo;
    TableRowSorter modeloOrdenado;
    Instancias instancias;
    vistaMenu vistaMenu = new vistaMenu();
    private String opcionCarga = "";

    public buscadorClientes(java.awt.Frame parent, boolean modal, vistaMenu menu, String opcionCarga) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(btnEste, javax.swing.GroupLayout.PREFERRED_SIZE, 169, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void btnEsteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEsteActionPerformed
        if (opcionCarga.equals("PAQUETE")) {
            vistaMenu.cargarClientePaquete(tblRegistros.getValueAt(tblRegistros.getSelectedRow(), 0).toString());
        } else {
            vistaMenu.cargarCliente(tblRegistros.getValueAt(tblRegistros.getSelectedRow(), 0).toString());
        }
    ...
    public void noEncontrado(String codigo) {
        ...
        tblRegistros.setModel(instancias.getSql().obtenerRegistrosClientesTabla());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                buscadorClientes dialog = new buscadorClientes(new javax.swing.JFrame(), true, null, "");
